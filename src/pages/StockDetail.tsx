...
/**
 * Volume is absent for some symbols, and rendering that as "0.0M" reads as a
 * stock that did not trade rather than a figure we do not have.
 */
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Card className="bg-card">
              <CardContent className="p-4">
                ...
                <div className="font-semibold">{formatVolume(stockData.volume)}</div>
              </CardContent>
            </Card>
          </div>
        )}
